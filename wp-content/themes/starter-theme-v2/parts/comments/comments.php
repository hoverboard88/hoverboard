...
if ( $comments ) {
	...
	<div class="comments container" id="comments">
		...
		<div class="comments-header section-inner small max-percentage">
			...
			<?php
			if ( ! have_comments() ) {
				echo wp_kses_post( _e( 'Leave a comment', 'twentytwenty' ) );
			} elseif ( '1' === $comments_number ) {
				/* translators: %s: post title */
				printf( esc_html( _x( 'One reply on &ldquo;%s&rdquo;', 'comments title', 'twentytwenty' ) ), esc_html( get_the_title() ) );
			} else {
				echo sprintf(
					esc_html(
...
if ( comments_open() || pings_open() ) {
	...
	<div class="comment-respond container" id="respond">
		...
		<p class="comments-closed"><?php esc_html( 'Comments are closed.' ); ?></p>
