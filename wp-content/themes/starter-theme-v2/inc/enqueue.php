...
function hb_enqueue_scripts() {
	...
	wp_enqueue_script( 'theme', get_template_directory_uri() . '/assets/js/modules.js', 'jquery', filemtime( get_stylesheet_directory() . '/assets/js/modules.js' ), true );
	wp_enqueue_script( 'theme', get_template_directory_uri() . '/assets/js/animate.js', 'jquery', filemtime( get_stylesheet_directory() . '/assets/js/animate.js' ), true );
}
