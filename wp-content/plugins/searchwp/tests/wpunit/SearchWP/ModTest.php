...
class ModTest extends \Codeception\TestCase\WPTestCase {
	...
	public function test_taxonomy_bonus_weight() {
		...
		//   + 1 Title match = 300
		//   + 1 Slug match  = 300
		//   + 1 Term match  = 100 * 2 for each Attribute hit, Title and Slug. Not ideal, but it's a bonus.
		//                   -----
		//                     800
	...
	public function test_bonus_weight_decays_over_time() {
		...
		$this->assertGreaterThan( 7200, intval( $query->results[0]->relevance ) );
		$this->assertGreaterThan( 3500, intval( $query->results[1]->relevance ) );
	}
