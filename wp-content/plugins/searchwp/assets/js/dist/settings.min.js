...
},{"./vue.common.prod.js":"QX3u"}],"Hfmr":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"XPQa":[function(require,module,exports) {
...
},{"vue":"Eruj"}],"haHd":[function(require,module,exports) {
...
},{"crypt":"haHd","charenc":"wMuc","is-buffer":"fPF1"}],"fcRi":[function(require,module,exports) {
"use strict";module.exports=function(t){return"object"==typeof t&&null!==t};
},{}],"DX1D":[function(require,module,exports) {
...
},{"vue":"Eruj"}],"BwJj":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e={name:"SearchwpInputText",props:{value:{type:[String,Number],default:""},label:{type:String,default:""},placeholder:{type:String,default:""}}};exports.default=e;
(function(){var t=exports.default||module.exports;"function"==typeof t&&(t=t.options),Object.assign(t,{render:function(){var t=this,e=t.$createElement,n=t._self._c||e;return n("div",{staticClass:"searchwp-input-text"},[n("label",{attrs:{for:"searchwp_input_text_"+t._uid}},[t._v(t._s(t.label))]),t._v(" "),n("input",{ref:"input",attrs:{type:"text",placeholder:t.placeholder,id:"searchwp_input_text_"+t._uid},domProps:{value:t.value},on:{input:function(e){return t.$emit("input",e.target.value)}}})])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{}],"P1oH":[function(require,module,exports) {
...
},{"./Tooltip.vue":"P1oH"}],"PNrX":[function(require,module,exports) {

},{}],"cmYO":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=o(require("vue")),t=o(require("md5")),s=require("./../EventBus.js"),i=o(require("./Button.vue"));function o(e){return e&&e.__esModule?e:{default:e}}function n(e,t,s){return t in e?Object.defineProperty(e,t,{value:s,enumerable:!0,configurable:!0,writable:!0}):e[t]=s,e}require("vue-multiselect/dist/vue-multiselect.min.css");var a={name:"SearchwpDropdown",components:{"searchwp-button":i.default},methods:{numberOfExcludedPostTypes:function(){return Object.keys(this.$root.misc.excluded_from_search).length},isWithoutCustomField:function(e){return-1!==this.$parent.indexOfObjectPropertyValue(this.getUnusedMetakeys(!0),"name",e)},getUnusedPostTypes:function(){var e=[],t=this.$parent.model.objects;for(var s in t)"searchwp_engine_label"===s||t[s].enabled||e.push({name:s,label:this.$root.$data.objects[s].label,value:s});return e},getUnusedNativeAttributes:function(){var e=[],t=this.$root.$data.objects[this.postType].supports;for(var s in t)e.push({name:s,label:t[s],value:s});var i=this.$parent.model.objects[this.postType].weights;return e.filter(function(e){return!i[e.name]||0===i[e.name]})},getUnusedTaxonomies:function(){var e=this.$root.$data.objects[this.postType].taxonomies,t=this.$parent.model.objects[this.postType].weights.tax;return e.filter(function(e){return!t.hasOwnProperty(e.name)||0==t[e.name]})},getUnusedRuleTaxonomies:function(e){var t=this.$root.$data.objects[this.postType].taxonomies,s=this.$parent.model.objects[this.postType].options;return t.filter(function(t){return!s.hasOwnProperty(e+"_"+t.name)})},getUnusedMetakeys:function(e,t){var s=[],i=this.$root.$data.objects[this.postType].meta_keys,o=this.$parent.model.objects[this.postType].weights.cf;for(var n in i){var a=i[n],r=!0;for(var d in o)if(o[d].metakey==a){r=!1;break}r&&(e||"searchwp_content"!==a&&"searchwp_pdf_metadata"!==a)&&s.push({name:a,label:"searchwpcfdefault"===a?this.i18n.anyCustomField+" ★":a,value:a})}return s.length&&t&&(s=this.groupMetakeys(s)),s},groupMetakeys:function(e){if(!e.length)return e;var t=!1,s=this.$parent.model.objects[this.postType].weights.cf;if(s)for(var i in s)s.hasOwnProperty(i)&&"searchwpcfdefault"===s[i].metakey&&(t=!0);var o=t?[]:["searchwpcfdefault"],a=t?[]:[{label:"Global",metakeys:[n({name:"searchwpcfdefault",label:this.i18n.anyCustomField+" ★"},"name","searchwpcfdefault")]}];for(var r in this.metaGroups)if(this.metaGroups.hasOwnProperty(r)){var d=this.metaGroups[r];a.push({label:d.label,metakeys:d.metakeys.map(function(e){return{name:e,label:e,value:e}})}),o=o.concat(d.metakeys)}return a.push({label:"Core",metakeys:e.filter(function(e){return o.indexOf(e.name)<0})}),a},showDetails:function(e){this.$refs.dropdownPopover&&this.$refs.dropdownPopover.hide(),this.showing=e},addNativeContentType:function(e){this.visible=!this.visible,this.$parent.model.objects[this.postType].weights[e.name]=1,0==this.getUnusedNativeAttributes().length&&(this.showing=""),this.$parent.$forceUpdate()},addTaxonomy:function(t){this.visible=!this.visible,this.$parent.model.objects[this.postType].weights.tax&&!Array.isArray(this.$parent.model.objects[this.postType].weights.tax)||e.default.set(this.$parent.model.objects[this.postType].weights,"tax",{}),this.$parent.model.objects[this.postType].weights.tax.hasOwnProperty(t.name)?this.$parent.model.objects[this.postType].weights.tax[t.name]=1:e.default.set(this.$parent.model.objects[this.postType].weights.tax,t.name,1),0==this.getUnusedTaxonomies().length&&(this.showing=""),this.indexInfluenced()},indexInfluenced:function(){s.EventBus.$emit("indexInfluenced")},addExcludedTaxonomy:function(t){this.visible=!this.visible,e.default.set(this.$parent.model.objects[this.postType].options,"exclude_"+t.name,[]),0==this.getUnusedRuleTaxonomies("exclude").length&&(this.showing="")},addLimitedToTaxonomy:function(t){this.visible=!this.visible,e.default.set(this.$parent.model.objects[this.postType].options,"limit_to_"+t.name,[]),0==this.getUnusedRuleTaxonomies("limit_to").length&&(this.showing="")},addPostType:function(t){this.$refs.dropdownPopover&&this.$refs.dropdownPopover.hide(),e.default.set(this.$parent.model.objects[t],"enabled",!0)},addMetakeyRecord:function(s,i){this.$refs.dropdownPopover&&this.$refs.dropdownPopover.hide();var o="swppv"+(0,t.default)(this.postType+s);this.$parent.model.objects[this.postType].weights.cf||e.default.set(this.$parent.model.objects[this.postType].weights,"cf",{}),e.default.set(this.$parent.model.objects[this.postType].weights.cf,o,{metakey:s,weight:1}),this.indexInfluenced()},addMetakey:function(e,t){this.visible=!this.visible,this.addMetakeyRecord(e.name),0==this.getUnusedMetakeys().length&&(this.showing="")}},computed:{excludedPostTypes:function(){return this.$root.misc.excluded_from_search},metaGroups:function(){var e=this.$root.objects[this.postType].meta_groups,t=this.$parent.model.objects[this.postType].weights.cf;if(!t)return e;var s=[];for(var i in t)t.hasOwnProperty(i)&&s.push(t[i].metakey);var o={};for(var n in e)if(e.hasOwnProperty(n)){var a=e[n];o[n]={label:a.label,metakeys:a.metakeys.filter(function(e){return s.indexOf(e)<0})}}return o}},data:function(){return{showing:"",i18n:{addExclusion:_SEARCHWP_VARS.i18n.add_exclusion,addLimiter:_SEARCHWP_VARS.i18n.add_limiter,anyCustomField:_SEARCHWP_VARS.i18n.any_custom_field,chooseNativeAttribute:_SEARCHWP_VARS.i18n.choose_native_attribute,chooseCustomField:_SEARCHWP_VARS.i18n.choose_custom_field,chooseTaxonomy:_SEARCHWP_VARS.i18n.choose_taxonomy,customField:_SEARCHWP_VARS.i18n.custom_field,documentContent:_SEARCHWP_VARS.i18n.document_content,documentProperties:_SEARCHWP_VARS.i18n.document_properties,done:_SEARCHWP_VARS.i18n.done,excludeByTaxonomy:_SEARCHWP_VARS.i18n.exclude_by_taxonomy,excluded:_SEARCHWP_VARS.i18n.excluded,excludedFromSearch:_SEARCHWP_VARS.i18n.excluded_from_search,limitByTaxonomy:_SEARCHWP_VARS.i18n.limit_by_taxonomy,pdfMetadata:_SEARCHWP_VARS.i18n.pdf_metadata,nativeAttribute:_SEARCHWP_VARS.i18n.native_attribute,search:_SEARCHWP_VARS.i18n.search,taxonomy:_SEARCHWP_VARS.i18n.taxonomy}}},props:{postType:{type:String,default:"post",required:!1},type:{type:String,default:"contentTypes",required:!0},buttonText:{type:String,required:!0},position:{type:String,default:"above",required:!1}}};exports.default=a;
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",{staticClass:"searchwp-dropdown"},[e.showing?e._e():o("v-popover",{ref:"dropdownPopover",attrs:{offset:"6"}},[o("searchwp-button",{attrs:{label:e.buttonText}}),e._v(" "),o("template",{slot:"popover"},["postTypes"==e.type?o("ul",[e._l(e.getUnusedPostTypes(),function(t){return o("li",{key:t.name,on:{click:function(o){return e.addPostType(t.name)}}},[e._v(e._s(t.label))])}),e._v(" "),e._l(e.excludedPostTypes,function(t){return o("li",{key:"excluded-"+t.name,staticClass:"searchwp-excluded-types-note"},[e._v(" "+e._s(e.i18n.excluded)+": "+e._s(t.label)+" ")])})],2):"contentTypes"==e.type?o("ul",[e.getUnusedNativeAttributes().length?o("li",{on:{click:function(t){return e.showDetails("native")}}},[e._v(e._s(e.i18n.nativeAttribute))]):e._e(),e._v(" "),e.getUnusedTaxonomies().length?o("li",{on:{click:function(t){return e.showDetails("taxonomy")}}},[e._v(e._s(e.i18n.taxonomy))]):e._e(),e._v(" "),"attachment"==e.postType&&e.isWithoutCustomField("searchwp_content")?o("li",{on:{click:function(t){return e.addMetakeyRecord("searchwp_content",!0)}}},[e._v(e._s(e.i18n.documentContent))]):e._e(),e._v(" "),"attachment"==e.postType&&e.isWithoutCustomField("searchwp_pdf_metadata")?o("li",{on:{click:function(t){return e.addMetakeyRecord("searchwp_pdf_metadata",!0)}}},[e._v(e._s(e.i18n.pdfMetadata))]):e._e(),e._v(" "),e.getUnusedMetakeys().length?o("li",{on:{click:function(t){return e.showDetails("meta")}}},[e._v(e._s(e.i18n.customField))]):e._e()]):"rules"==e.type?o("ul",[e.getUnusedRuleTaxonomies("exclude").length?o("li",{on:{click:function(t){return e.showDetails("excludeTaxonomy")}}},[e._v(e._s(e.i18n.excludeByTaxonomy))]):e._e(),e._v(" "),e.getUnusedRuleTaxonomies("limit_to").length?o("li",{on:{click:function(t){return e.showDetails("limitToTaxonomy")}}},[e._v(e._s(e.i18n.limitByTaxonomy))]):e._e()]):e._e()])],2),e._v(" "),e.showing?o("div",{staticClass:"searchwp-dropdown-choices"},["native"==e.showing?o("multiselect",{attrs:{label:"label",placeholder:e.i18n.chooseNativeAttribute,options:e.getUnusedNativeAttributes(),searchable:!1,"allow-empty":!1,"reset-after":!0},on:{select:e.addNativeContentType}}):e._e(),e._v(" "),"taxonomy"==e.showing?o("multiselect",{attrs:{label:"label",placeholder:e.i18n.chooseTaxonomy,options:e.getUnusedTaxonomies(),searchable:!1,"allow-empty":!1,"reset-after":!0},on:{select:e.addTaxonomy}}):e._e(),e._v(" "),"meta"==e.showing?o("multiselect",{attrs:{label:"label",placeholder:e.i18n.chooseCustomField,options:e.getUnusedMetakeys(!1,!0),"group-values":"metakeys","group-label":"label","group-select":!1,searchable:!0,"allow-empty":!0,"reset-after":!0},on:{select:e.addMetakey}}):e._e(),e._v(" "),"excludeTaxonomy"==e.showing?o("multiselect",{attrs:{label:"label",placeholder:e.i18n.chooseTaxonomy,options:e.getUnusedRuleTaxonomies("exclude"),searchable:!1,"allow-empty":!1,"reset-after":!0},on:{select:e.addExcludedTaxonomy}}):e._e(),e._v(" "),"limitToTaxonomy"==e.showing?o("multiselect",{attrs:{label:"label",placeholder:e.i18n.chooseTaxonomy,options:e.getUnusedRuleTaxonomies("limit_to"),searchable:!1,"allow-empty":!1,"reset-after":!0},on:{select:e.addLimitedToTaxonomy}}):e._e(),e._v(" "),o("searchwp-button",{attrs:{label:e.i18n.done},nativeOn:{click:function(t){t.preventDefault(),e.showing=""}}})],1):e._e()],1)},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"vue":"Eruj","md5":"EzLX","./../EventBus.js":"XPQa","./Button.vue":"arid","vue-multiselect/dist/vue-multiselect.min.css":"PNrX"}],"yr2B":[function(require,module,exports) {
...
},{}],"Egz1":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=s(require("debounce")),t=s(require("vue"));function s(e){return e&&e.__esModule?e:{default:e}}var i={name:"SearchwpInputTaxonomyTerms",data:function(){return{selectedTerms:this.$parent.model.objects[this.postType].options[this.mode+"_"+this.taxonomy],terms:[],isLoading:!1,open:!1,closed:!0,i18n:{findTerms:_SEARCHWP_VARS.i18n.search_terms,noTermsFound:_SEARCHWP_VARS.i18n.no_terms_found,searchToFindTerms:_SEARCHWP_VARS.i18n.search_to_choose_terms}}},methods:{updateTerms:function(){t.default.set(this.$parent.model.objects[this.postType].options,this.mode+"_"+this.taxonomy,this.selectedTerms),this.$emit("termsUpdated",this.postType,this.taxonomy,this.selectedTerms.length)},asyncFind:(0,e.default)(function(e){var s=this;this.isLoading=!0,""!=e?t.default.SearchwpSearchTaxonomyTerms(e,this.taxonomy,this.postType).then(function(e){s.terms=e,s.isLoading=!1}).catch(function(e){this.isLoading=!1}):this.isLoading=!1},500),clearAll:function(){this.selectedTerms=[]}},created:function(){this.terms.length&&(this.selectedTerms=this.terms)},props:{label:{type:String,default:"",required:!0},taxonomy:{type:String,required:!0},postType:{type:String,required:!0},mode:{type:String,default:"exclude",required:!0},value:{type:Object,default:function(){return{}},required:!1}}};exports.default=i;
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("div",{staticClass:"searchwp-input-taxonomy-terms"},[t("label",[e._v(e._s(e.label))]),e._v(" "),t("div",[t("multiselect",{attrs:{label:"label","track-by":"value",placeholder:e.i18n.findTerms,options:e.terms,multiple:!0,searchable:!0,loading:e.isLoading,"internal-search":!1,"clear-on-select":!0,"close-on-select":!0,"max-height":300,"show-no-results":!0,"hide-selected":!0},on:{input:function(s){return e.updateTerms()},closed:function(s){e.closed=!0},"search-change":e.asyncFind},model:{value:e.selectedTerms,callback:function(s){e.selectedTerms=s},expression:"selectedTerms"}},[t("span",{attrs:{slot:"noResult"},slot:"noResult"},[e._v(e._s(e.i18n.noTermsFound))]),e._v(" "),t("span",{attrs:{slot:"noOptions"},slot:"noOptions"},[e._v(e._s(e.i18n.searchToFindTerms))])])],1)])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"debounce":"yr2B","vue":"Eruj"}],"h4pB":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=h(require("vue")),t=require("./../EventBus.js"),i=h(require("md5")),s=h(require("slugify")),n=h(require("vue-slider-component")),o=h(require("./Remove.vue")),a=h(require("./Button.vue")),r=h(require("./InputText.vue")),d=h(require("./InputCheckbox.vue")),u=h(require("./Dropdown.vue")),l=h(require("./InputTaxonomyTerms.vue")),_=h(require("./Message.vue"));function h(e){return e&&e.__esModule?e:{default:e}}var c={name:"SearchwpEngine",components:{"searchwp-slider":n.default,"searchwp-remove":o.default,"searchwp-button":a.default,"searchwp-dropdown":u.default,"searchwp-input-text":r.default,"searchwp-input-checkbox":d.default,"searchwp-input-taxonomy-terms":l.default,"searchwp-message":_.default},computed:{getName:function(){return this.model.name},hasDocumentProperties:function(){var e=-1===this.indexOfObjectPropertyValue(this.unusedMetakeys("attachment",!0),"name","searchwp_content"),t=-1===this.indexOfObjectPropertyValue(this.unusedMetakeys("attachment",!0),"name","searchwp_pdf_metadata");return e||t},hasPostTypes:function(){var e=[];for(var t in this.model.objects)"searchwp_engine_label"!==t&&this.model.objects[t].enabled&&e.push(t);return!!e.length}},methods:{excludedTermsUpdated:function(t,i,s){s<1&&e.default.delete(this.model.objects[t].options,"exclude_"+i)},limitedToTermsUpdated:function(t,i,s){s<1&&e.default.delete(this.model.objects[t].options,"limit_to_"+i)},removeTaxonomy:function(e,t){this.model.objects[e].weights.tax[this.attributes[e].taxonomies[t].name]=0,this.indexInfluenced()},indexInfluenced:function(){t.EventBus.$emit("indexInfluenced")},updateName:function(){var t=(0,s.default)(this.label.replace(/ /gi,"_"),{replacement:"_",remove:/[^a-z0-9_]/gi,lower:!0});e.default.set(this.model,"name",t),e.default.set(this.$parent.engines[this.ref],"searchwp_engine_label",this.label)},hasAttributes:function(t){var i=[],s=this.model.objects[t];for(var n in this.attributes[t].supports)s.weights[n]&&i.push(n);for(var o in this.attributes[t].taxonomies){var a=this.attributes[t].taxonomies[o].name;this.model.objects[t].weights.tax&&!Array.isArray(this.model.objects[t].weights.tax)||e.default.set(this.model.objects[t].weights,"tax",{}),s.weights.tax[a]&&i.push(a)}for(var r in s.weights.cf){var d=s.weights.cf[r].metakey;i.push(d)}return!!i.length},removeEngine:function(){e.default.delete(this.$root.engines,this.ref)},removePostType:function(t){if(this.model.objects[t].enabled=!1,e.default.set(this.model.objects[t].weights,"cf",{}),this.model.objects[t].weights.tax)for(var i in this.attributes[t].taxonomies){var s=this.attributes[t].taxonomies[i].name;this.model.objects[t].weights.tax[s]&&(this.model.objects[t].weights.tax[s]=0)}this.details.indexOf(t)>-1&&this.details.splice(this.details.indexOf(t),1)},indexOfObjectPropertyValue:function(e,t,i){for(var s=0;s<e.length;s+=1)if(e[s][t]===i)return s;return-1},hasCustomFields:function(e){var t=this.model.objects[e].weights.cf&&Object.keys(this.model.objects[e].weights.cf).length>0;if(t&&"attachment"==e){var i=this.model.objects[e].weights.cf,s=0;for(var n in i)"searchwp_content"==i[n].metakey&&s++,"searchwp_pdf_metadata"==i[n].metakey&&s++;Object.keys(this.model.objects[e].weights.cf).length<=s&&(t=!1)}return t},removeMetakey:function(t,i){e.default.delete(this.model.objects[t].weights.cf,i)},unusedPostTypes:function(){var e=[],t=this.model.objects;for(var i in t)"searchwp_engine_label"===i||t[i].enabled||e.push({name:i,label:this.$root.$data.objects[i].label,value:i});return e},unusedNativeAttributes:function(e){var t=[],i=this.$root.$data.objects[e].supports;for(var s in i)t.push(s);var n=this.model.objects[e].weights;return t.filter(function(e){return 0==n[e]})},unusedTaxonomies:function(e){var t=this.$root.$data.objects[e].taxonomies,i=this.model.objects[e].weights.tax;return t.filter(function(e){return 0==i[e.name]})},unusedMetakeys:function(e,t){var i=[],s=this.$root.$data.objects[e].meta_keys,n=this.model.objects[e].weights.cf;for(var o in s){var a=s[o],r=!0;for(var d in n)if(n[d].metakey==a){r=!1;break}r&&(t||"searchwp_content"!==a&&"searchwp_pdf_metadata"!==a)&&i.push({name:a,label:a,value:a})}return i},unusedAttributes:function(e){return this.unusedNativeAttributes(e).length||this.unusedTaxonomies(e).length||this.unusedMetakeys(e,!0).length},toggleDetails:function(e){this.details.includes(e)?this.details=this.details.filter(function(t){return t!=e}):this.details.push(e)},getTooltipText:function(e){return e<Math.ceil(.02*this.weightMax)?_SEARCHWP_VARS.i18n.minimum+" ("+e+")":e<Math.ceil(.3*this.weightMax)?_SEARCHWP_VARS.i18n.a_little+" ("+e+")":e<Math.ceil(.65*this.weightMax)?_SEARCHWP_VARS.i18n.average+" ("+e+")":e<Math.ceil(.99*this.weightMax)?_SEARCHWP_VARS.i18n.a_lot+" ("+e+")":_SEARCHWP_VARS.i18n.maximum+" ("+e+")"}},data:function(){return{model:{name:this.name,objects:{}},dirtyIndex:!1,ref:this.name,label:_SEARCHWP_VARS.i18n.default,editingLabel:!1,attributes:this.$root.$data.objects,stemming_supported:this.$root.$data.stemming_supported,weightMax:parseInt(_SEARCHWP_VARS.data.misc.max_weight,10),i18n:{addAttribute:_SEARCHWP_VARS.i18n.add_attribute,addContentType:_SEARCHWP_VARS.i18n.add_content_type,addLimitExcludeRule:_SEARCHWP_VARS.i18n.add_limit_exclude_rule,addPostType:_SEARCHWP_VARS.i18n.add_post_type,adminEngineNote:_SEARCHWP_VARS.i18n.admin_engine_note,anyCustomField:_SEARCHWP_VARS.i18n.any_custom_field,assignWeightTo:_SEARCHWP_VARS.i18n.assign_weight_to,attribute:_SEARCHWP_VARS.i18n.attribute,attributeResultsTo:_SEARCHWP_VARS.i18n.attribute_results_to,attribution:_SEARCHWP_VARS.i18n.attribution,choose:_SEARCHWP_VARS.i18n.choose,commaSeparatedIds:_SEARCHWP_VARS.i18n.comma_separated_ids,contentType:_SEARCHWP_VARS.i18n.content_type,customField:_SEARCHWP_VARS.i18n.custom_field,customFields:_SEARCHWP_VARS.i18n.custom_fields,default:_SEARCHWP_VARS.i18n.default,defaultEngineNote:_SEARCHWP_VARS.i18n.default_engine_note,deleteEngine:_SEARCHWP_VARS.i18n.delete_engine,documentContent:_SEARCHWP_VARS.i18n.document_content,documentProperties:_SEARCHWP_VARS.i18n.document_properties,done:_SEARCHWP_VARS.i18n.done,engineNote:_SEARCHWP_VARS.i18n.engine_note,engineNoteNone:_SEARCHWP_VARS.i18n.engine_note_none,exclude:_SEARCHWP_VARS.i18n.exclude,excluded:_SEARCHWP_VARS.i18n.excluded,excludedIds:_SEARCHWP_VARS.i18n.excluded_ids,limitTo:_SEARCHWP_VARS.i18n.limit_to,limitedTo:_SEARCHWP_VARS.i18n.limited_to,note:_SEARCHWP_VARS.i18n.note,notAvailableNoIndex:_SEARCHWP_VARS.i18n.not_available_no_index,options:_SEARCHWP_VARS.i18n.options,pdfMetadata:_SEARCHWP_VARS.i18n.pdf_metadata,rules:_SEARCHWP_VARS.i18n.rules,singlePostId:_SEARCHWP_VARS.i18n.single_post_id,statistics:_SEARCHWP_VARS.i18n.statistics,taxonomy:_SEARCHWP_VARS.i18n.taxonomy,taxonomies:_SEARCHWP_VARS.i18n.taxonomies,transferWeightTo:_SEARCHWP_VARS.i18n.transfer_weight_to,transferWeightToParent:_SEARCHWP_VARS.i18n.transfer_weight_to_parent,useKeywordStem:_SEARCHWP_VARS.i18n.use_keyword_stem,weight:_SEARCHWP_VARS.i18n.weight,weightMultiplier:_SEARCHWP_VARS.i18n.weight_multiplier,weightAssignment:_SEARCHWP_VARS.i18n.weight_assignment,weightTransfer:_SEARCHWP_VARS.i18n.weight_transfer,withoutAttributesNoResults:_SEARCHWP_VARS.i18n.without_attributes_no_results},details:[]}},props:{settings:{type:Object,default:{},required:!1},name:{type:String,default:"default",required:!0},isAdminEngine:{type:Boolean,default:!1}},created:function(){for(var e in this.settings)"searchwp_engine_label"!=e?this.model.objects[e]=this.settings[e]:this.label=this.settings[e];for(var e in this.model.objects)this.model.objects[e].options&&!this.model.objects[e].options.hasOwnProperty("stem")&&(this.model.objects[e].options.stem=!1);for(var e in this.model.objects){if(!this.model.objects[e].options)break;for(var t in this.model.objects[e].options.hasOwnProperty("stem")?"0"===this.model.objects[e].options.stem?this.model.objects[e].options.stem=!1:this.model.objects[e].options.stem=!!this.model.objects[e].options.stem:this.model.objects[e].options.stem=!1,this.model.objects[e].options)"0"===this.model.objects[e].options[t]&&(this.model.objects[e].options[t]="")}this.label||(this.label=this.i18n.default),"searchwp_engine_hash_"==this.model.name.substring(0,21)&&this.updateName()}};exports.default=c;
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,t=e.$createElement,s=e._self._c||t;return s("div",{staticClass:"searchwp-engine postbox"},[s("h3",{staticClass:"hndle"},[e.editingLabel?e._e():s("span",{class:{"searchwp-hndle-default":!e.settings.hasOwnProperty("searchwp_engine_label")||e.isAdminEngine},on:{click:function(t){e.settings.hasOwnProperty("searchwp_engine_label")&&!e.isAdminEngine?e.editingLabel=!0:e.editingLabel=!1}}},[e._v(e._s(e.label)+" "),e.settings.hasOwnProperty("searchwp_engine_label")&&!e.isAdminEngine?s("span",{staticClass:"dashicons dashicons-edit"}):e._e()]),e._v(" "),!e.settings.hasOwnProperty("searchwp_engine_label")||!e.editingLabel&&e.settings.searchwp_engine_label?e._e():s("input",{directives:[{name:"model",rawName:"v-model",value:e.label,expression:"label"}],domProps:{value:e.label},on:{input:[function(t){t.target.composing||(e.label=t.target.value)},function(t){return e.updateName()}],keyup:[function(t){if(!t.type.indexOf("key")&&e._k(t.keyCode,"enter",13,t.key,"Enter"))return null;e.editingLabel=!1},function(t){if(!t.type.indexOf("key")&&e._k(t.keyCode,"esc",27,t.key,["Esc","Escape"]))return null;e.editingLabel=!1}]}}),e._v(" "),!e.settings.hasOwnProperty("searchwp_engine_label")||!e.editingLabel&&e.settings.searchwp_engine_label?e._e():s("span",{staticClass:"button",on:{click:function(t){t.preventDefault(),e.editingLabel=!(e.editingLabel&&e.settings.searchwp_engine_label)}}},[e._v(e._s(e.i18n.done))]),e._v(" "),e.settings.hasOwnProperty("searchwp_engine_label")?s("code",[e._v(e._s(e.getName))]):e._e(),e._v(" "),s("a",{attrs:{href:e.$root.misc.stats_url+"&tab="+e.getName}},[e._v(e._s(e.i18n.statistics))])]),e._v(" "),s("div",{staticClass:"inside"},[e.settings.hasOwnProperty("searchwp_engine_label")?e.isAdminEngine?s("p",{staticClass:"description searchwp-engine-note"},[s("span",{staticClass:"dashicons dashicons-lightbulb"}),e._v(e._s(e.i18n.adminEngineNote))]):s("p",{staticClass:"description searchwp-engine-note"},[e._v(e._s(e.i18n.engineNote))]):s("p",{staticClass:"description searchwp-engine-note"},[s("span",{staticClass:"dashicons dashicons-info"}),e._v(e._s(e.i18n.defaultEngineNote))]),e._v(" "),e.hasPostTypes?e._e():s("p",{staticClass:"description searchwp-engine-note"},[s("strong",[e._v(e._s(e.i18n.note))]),e._v(" "+e._s(e.i18n.engineNoteNone))]),e._v(" "),e._l(e.settings,function(t,o){return"searchwp_engine_label"!==o&&e.model.objects[o].enabled?s("div",{key:o,staticClass:"searchwp-engine-post-type"},[e.attributes&&e.attributes[o]?s("div",[s("h4",{staticClass:"searchwp-engine-post-type__heading"},[s("span",{staticClass:"searchwp-engine-post-type__label",on:{click:function(t){return e.toggleDetails(o)}}},[e.details.includes(o)?e._e():s("span",{staticClass:"dashicons dashicons-arrow-right"}),e._v(" "),e.details.includes(o)?s("span",{staticClass:"dashicons dashicons-arrow-down"}):e._e(),e._v(" "+e._s(e.attributes[o].label)+" ")]),e._v(" "),e.details.includes(o)?s("searchwp-remove",{attrs:{text:e.i18n.exclude},nativeOn:{click:function(t){return t.preventDefault(),e.removePostType(o)}}}):e._e()],1),e._v(" "),e.details.includes(o)?s("div",{staticClass:"searchwp-engine-post-type__details"},[s("div",{staticClass:"searchwp-engine-post-type__weights"},[e.hasAttributes(o)?s("table",[e._m(0,!0),e._v(" "),s("thead",[s("tr",[s("th",[e._v(e._s(e.i18n.attribute))]),e._v(" "),s("th",[e._v(e._s(e.i18n.weightMultiplier))])])]),e._v(" "),e.attributes[o].supports&&e.model.objects[o]?s("tbody",[e._l(e.attributes[o].supports,function(t,a){return e.model.objects[o].weights[a]?s("tr",{key:e.attributes[o].name+a},[s("td",[e._v(" "+e._s(t)+" "),s("searchwp-remove",{attrs:{icon:!0},nativeOn:{click:function(t){t.preventDefault(),e.model.objects[o].weights[a]=0}}})],1),e._v(" "),s("td",[s("searchwp-slider",{attrs:{height:3,"dot-size":11,min:1,max:e.weightMax,interval:1,formatter:e.getTooltipText,tooltip:"hover","bg-style":{backgroundColor:"#dddddd"},"process-style":{backgroundColor:"#159FD2"},"tooltip-style":{backgroundColor:"#159FD2",color:"#ffffff",fontSize:"13px"}},model:{value:e.model.objects[o].weights[a],callback:function(t){e.$set(e.model.objects[o].weights,a,t)},expression:"model.objects[ postTypeName ].weights[ supportsKey ]"}})],1)]):e._e()}),e._v(" "),e.model.objects[o].weights.tax&&e.unusedTaxonomies(o).length!==Object.keys(e.model.objects[o].weights.tax).length?s("tr",{staticClass:"searchwp-engine-post-type__attribute-category"},[s("th",[e._v(e._s(e.i18n.taxonomies))])]):e._e(),e._v(" "),e._l(e.attributes[o].taxonomies,function(t,a){return e.model.objects[o].weights.tax[e.attributes[o].taxonomies[a].name]?s("tr",{key:e.attributes[o].name+"tax"+a},[s("td",[e._v(" "+e._s(e.attributes[o].taxonomies[a].label)+" "),s("searchwp-remove",{attrs:{icon:!0},nativeOn:{click:function(t){return t.preventDefault(),e.removeTaxonomy(o,a)}}})],1),e._v(" "),s("td",[s("searchwp-slider",{attrs:{height:3,"dot-size":11,min:1,max:e.weightMax,interval:1,formatter:e.getTooltipText,tooltip:"hover","bg-style":{backgroundColor:"#dddddd"},"process-style":{backgroundColor:"#159FD2"},"tooltip-style":{backgroundColor:"#159FD2",color:"#ffffff",fontSize:"13px"}},model:{value:e.model.objects[o].weights.tax[e.attributes[o].taxonomies[a].name],callback:function(t){e.$set(e.model.objects[o].weights.tax,e.attributes[o].taxonomies[a].name,t)},expression:"model.objects[ postTypeName ].weights.tax[ attributes[ postTypeName ].taxonomies[ taxonomyKey ].name ]"}})],1)]):e._e()}),e._v(" "),"attachment"==o&&e.hasDocumentProperties?s("tr",{staticClass:"searchwp-engine-post-type__attribute-category"},[s("th",[e._v(e._s(e.i18n.documentProperties))])]):e._e(),e._v(" "),e._l(e.model.objects[o].weights.cf,function(t,a){return"searchwp_content"==e.model.objects[o].weights.cf[a].metakey||"searchwp_pdf_metadata"==e.model.objects[o].weights.cf[a].metakey?s("tr",{key:e.attributes[o].name+"meta"+a},[s("td",["searchwp_content"==e.model.objects[o].weights.cf[a].metakey?s("span",[e._v(e._s(e.i18n.documentContent))]):"searchwp_pdf_metadata"==e.model.objects[o].weights.cf[a].metakey?s("span",[e._v(e._s(e.i18n.pdfMetadata))]):e._e(),e._v(" "),s("searchwp-remove",{attrs:{icon:!0},nativeOn:{click:function(t){return t.preventDefault(),e.removeMetakey(o,a)}}})],1),e._v(" "),s("td",[s("searchwp-slider",{attrs:{height:3,"dot-size":11,min:1,max:e.weightMax,interval:1,formatter:e.getTooltipText,tooltip:"hover","bg-style":{backgroundColor:"#dddddd"},"process-style":{backgroundColor:"#159FD2"},"tooltip-style":{backgroundColor:"#159FD2",color:"#ffffff",fontSize:"13px"}},model:{value:e.model.objects[o].weights.cf[a].weight,callback:function(t){e.$set(e.model.objects[o].weights.cf[a],"weight",t)},expression:"model.objects[ postTypeName ].weights.cf[ metakeyKey ].weight"}})],1)]):e._e()}),e._v(" "),e.hasCustomFields(o)?s("tr",{staticClass:"searchwp-engine-post-type__attribute-category"},[s("th",[e._v(e._s(e.i18n.customFields))])]):e._e(),e._v(" "),e._l(e.model.objects[o].weights.cf,function(t,a){return"attachment"!=o||"searchwp_content"!=e.model.objects[o].weights.cf[a].metakey&&"searchwp_pdf_metadata"!=e.model.objects[o].weights.cf[a].metakey?s("tr",{key:e.attributes[o].name+"meta"+a},[s("td",["searchwpcfdefault"===e.model.objects[o].weights.cf[a].metakey||"searchwp cf default"===e.model.objects[o].weights.cf[a].metakey?s("span",[s("em",[e._v(e._s(e.i18n.anyCustomField))]),e._v(" "),s("span",{staticClass:"dashicons dashicons-star-filled"})]):s("span",[e._v(" "+e._s(e.model.objects[o].weights.cf[a].metakey)+" ")]),e._v(" "),s("searchwp-remove",{attrs:{icon:!0},nativeOn:{click:function(t){return t.preventDefault(),e.removeMetakey(o,a)}}})],1),e._v(" "),s("td",[s("searchwp-slider",{attrs:{height:3,"dot-size":11,min:1,max:e.weightMax,interval:1,formatter:e.getTooltipText,tooltip:"hover","bg-style":{backgroundColor:"#dddddd"},"process-style":{backgroundColor:"#159FD2"},"tooltip-style":{backgroundColor:"#159FD2",color:"#ffffff",fontSize:"13px"}},model:{value:e.model.objects[o].weights.cf[a].weight,callback:function(t){e.$set(e.model.objects[o].weights.cf[a],"weight",t)},expression:"model.objects[ postTypeName ].weights.cf[ metakeyKey ].weight"}})],1)]):e._e()})],2):e._e()]):s("searchwp-message",{attrs:{type:"warning"}},[s("p",[e._v(e._s(e.i18n.withoutAttributesNoResults))])]),e._v(" "),e.unusedAttributes(o)?s("searchwp-dropdown",{attrs:{type:"contentTypes",postType:o,buttonText:e.i18n.addAttribute}}):e._e(),e._v(" "),"attachment"!=o||e.$root.misc.ziparchive&&e.$root.misc.domdocument?e._e():s("div",{staticClass:"searchwp-document-notes"},[e.$root.misc.ziparchive?e._e():s("p",{staticClass:"description"},[s("strong",[e._v(e._s(e.i18n.note))]),e._v(" "),s("code",[e._v("ZipArchive")]),e._v(" "+e._s(e.i18n.notAvailableNoIndex))]),e._v(" "),e.$root.misc.domdocument?e._e():s("p",{staticClass:"description"},[s("strong",[e._v(e._s(e.i18n.note))]),e._v(" "),s("code",[e._v("DOMDocument")]),e._v(" "+e._s(e.i18n.notAvailableNoIndex))])])],1),e._v(" "),s("div",{staticClass:"searchwp-engine-post-type__options"},[s("div",[s("h5",[e._v(e._s(e.i18n.weightTransfer))]),e._v(" "),"id"==e.$root.objects[o].attribution?s("searchwp-input-text",{attrs:{label:e.i18n.transferWeightTo,placeholder:e.i18n.singlePostId},model:{value:e.model.objects[o].options.attribute_to,callback:function(t){e.$set(e.model.objects[o].options,"attribute_to",t)},expression:"model.objects[ postTypeName ].options.attribute_to"}}):e._e(),e._v(" "),"parent"==e.$root.objects[o].attribution?s("searchwp-input-checkbox",{attrs:{label:e.i18n.transferWeightToParent,checked:e.model.objects[o].options.parent},model:{value:e.model.objects[o].options.parent,callback:function(t){e.$set(e.model.objects[o].options,"parent",t)},expression:"model.objects[ postTypeName ].options.parent"}}):e._e()],1),e._v(" "),e.stemming_supported?s("div",[s("h5",[e._v(e._s(e.i18n.options))]),e._v(" "),s("searchwp-input-checkbox",{attrs:{label:e.i18n.useKeywordStem,checked:e.model.objects[o].options.stem},model:{value:e.model.objects[o].options.stem,callback:function(t){e.$set(e.model.objects[o].options,"stem",t)},expression:"model.objects[ postTypeName ].options.stem"}})],1):e._e(),e._v(" "),s("div",[s("h5",[e._v(e._s(e.i18n.rules))]),e._v(" "),s("searchwp-input-text",{attrs:{label:e.i18n.excludedIds,placeholder:e.i18n.commaSeparatedIds},model:{value:e.model.objects[o].options.exclude,callback:function(t){e.$set(e.model.objects[o].options,"exclude",t)},expression:"model.objects[ postTypeName ].options.exclude"}}),e._v(" "),"attachment"==o?s("div",{staticClass:"searchwp-input-taxonomy-terms"},[s("label",[e._v("Limit to file type")]),e._v(" "),s("div",[s("multiselect",{attrs:{label:"label","track-by":"value",placeholder:e.i18n.choose,options:e.$root.misc.mimes,multiple:!0,searchable:!1,"internal-search":!1,"clear-on-select":!0,"close-on-select":!0,"max-height":300,"show-no-results":!1,"hide-selected":!0},model:{value:e.model.objects[o].options.mimes,callback:function(t){e.$set(e.model.objects[o].options,"mimes",t)},expression:"model.objects[ postTypeName ].options.mimes"}})],1)]):e._e(),e._v(" "),e._l(e.attributes[o].taxonomies,function(t,a){return e.model.objects[o].options.hasOwnProperty("exclude_"+e.attributes[o].taxonomies[a].name)?s("searchwp-input-taxonomy-terms",{key:e.attributes[o].name+"tax"+a,attrs:{label:e.i18n.excluded+" "+e.attributes[o].taxonomies[a].label,mode:"exclude",postType:o,taxonomy:e.attributes[o].taxonomies[a].name},on:{termsUpdated:e.excludedTermsUpdated}}):e._e()}),e._v(" "),e._l(e.attributes[o].taxonomies,function(t,a){return e.model.objects[o].options.hasOwnProperty("limit_to_"+e.attributes[o].taxonomies[a].name)?s("searchwp-input-taxonomy-terms",{key:e.attributes[o].name+"tax"+a,attrs:{label:e.i18n.limitTo+" "+e.attributes[o].taxonomies[a].label,mode:"limit_to",postType:o,taxonomy:e.attributes[o].taxonomies[a].name},on:{termsUpdated:e.limitedToTermsUpdated}}):e._e()}),e._v(" "),e.attributes[o].taxonomies.length?s("searchwp-dropdown",{attrs:{type:"rules",postType:o,buttonText:e.i18n.addLimitExcludeRule}}):e._e()],2)])]):e._e()]):e._e()]):e._e()}),e._v(" "),s("ul",{staticClass:"searchwp-engine-actions"},[s("li",[e.unusedPostTypes().length?s("searchwp-dropdown",{attrs:{type:"postTypes",position:"below",buttonText:e.i18n.addPostType}}):e._e()],1),e._v(" "),"default"===e.model.name||e.isAdminEngine?e._e():s("li",{staticClass:"searchwp-remove-engine"},[s("searchwp-remove",{attrs:{text:e.i18n.deleteEngine},nativeOn:{click:function(t){return t.preventDefault(),e.removeEngine()}}})],1)])],2)])},staticRenderFns:[function(){var e=this.$createElement,t=this._self._c||e;return t("colgroup",[t("col",{staticClass:"searchwp-engine-post-type-attribute"}),this._v(" "),t("col",{staticClass:"searchwp-engine-post-type-attribute-weight"})])}],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"vue":"Eruj","./../EventBus.js":"XPQa","md5":"EzLX","slugify":"C1bb","vue-slider-component":"pdE9","./Remove.vue":"RkJL","./Button.vue":"arid","./InputText.vue":"BwJj","./InputCheckbox.vue":"ezTy","./Dropdown.vue":"cmYO","./InputTaxonomyTerms.vue":"Egz1","./Message.vue":"xxAh"}],"nLgC":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=g(require("vue")),i=require("./../EventBus.js"),n=g(require("md5")),t=g(require("keyfinder")),a=g(require("array-unique")),r=g(require("./EnvironmentCheck.vue")),s=g(require("./Engine.vue")),d=g(require("./Message.vue"));function g(e){return e&&e.__esModule?e:{default:e}}var o={name:"SearchwpEngines",components:{"searchwp-environment-check":r.default,"searchwp-engine":s.default,"searchwp-message":d.default},data:function(){return{adminSearchEnabled:_SEARCHWP_VARS.data.misc.admin_search,adminSearchEngine:_SEARCHWP_VARS.data.misc.admin_engine,waiting:!1,engines:_SEARCHWP_VARS.data.engines,initialFingerprint:"",fingerprint:"",dirtyIndex:!1,saving:!1,doingSave:!1,saved:!1,initialSettingsSaved:_SEARCHWP_VARS.data.misc.initial_settings_saved,legacySettings:_SEARCHWP_VARS.data.misc.legacy_settings,i18n:{addEngine:_SEARCHWP_VARS.i18n.add_engine,indexDirtyFromEnginesSave:_SEARCHWP_VARS.i18n.index_dirty_from_engines_save,problemSavingEngineSettings:_SEARCHWP_VARS.i18n.problem_saving_engine_settings,rebuildIndex:_SEARCHWP_VARS.i18n.rebuild_index,saveEngines:_SEARCHWP_VARS.i18n.save_engines,saved:_SEARCHWP_VARS.i18n.saved,dismiss:_SEARCHWP_VARS.i18n.dismiss,legacySettingsNotice:_SEARCHWP_VARS.i18n.legacy_settings_notice,initialSettingsNotice:_SEARCHWP_VARS.i18n.initial_settings_notice,moreInfo:_SEARCHWP_VARS.i18n.more_info,useDefaults:_SEARCHWP_VARS.i18n.use_defaults}}},methods:{dismissLegacySettings:function(){this.legacySettings=!1,e.default.SearchwpSetSetting("legacy_engines",JSON.stringify(!1)).then(function(e){})},resetIndex:function(){var n=this;n.dirtyIndex=!1,i.EventBus.$emit("indexReset"),n.waiting=!0,e.default.SearchwpResetIndex().then(function(e){n.initialFingerprint=JSON.parse(JSON.stringify(n.fingerprint)),_SEARCHWP_VARS.data.misc.alternate_indexer?window.location.reload():n.waiting=!1}).catch(function(e){alert("ERROR SEARCHWPINDEXRESET")})},addEngine:function(){var i=new Date,t="searchwp_engine_hash_"+(0,n.default)("searchwp_engine_hash_"+i.getTime());e.default.set(this.engines,t,JSON.parse(JSON.stringify(this.$root.engine_model)))},saveEngines:function(){var i=this,n=!1;i.saving=!0,i.doingSave=!0,i.fingerprint=i.generateFingerprint(),i.legacySettings&&(i.legacySettings=!1,n=!0),e.default.SearchwpSetSetting("engines",JSON.stringify(i.engines)).then(function(e){i.saving=!1,n&&i.dismissLegacySettings(),i.afterSaveEngines()}).catch(function(e){alert(i.i18n.problemSavingEngineSettings)})},afterSaveEngines:function(){var n=this;this.initialSettingsSaved?n.dirtyIndex=n.isIndexDirty():(this.initialSettingsSaved=!0,this.resetIndex()),i.EventBus.$emit("enginesSaved",{initialFingerprint:JSON.stringify(n.initialFingerprint),currentFingerprint:JSON.stringify(n.fingerprint),engines:n.engines,dirtyIndex:n.dirtyIndex}),e.default.SearchwpSetSetting("index_dirty",JSON.stringify(n.dirtyIndex)).then(function(e){}),n.saved=!0,setTimeout(function(){n.doingSave=!1,n.saved=!1},1600)},isIndexDirty:function(){for(var e=!1,i=0;i<this.initialFingerprint.postTypes.length;i++)-1==this.fingerprint.postTypes.indexOf(this.initialFingerprint.postTypes[i])&&(e=!0);if(!e){var n=JSON.parse(JSON.stringify(this.initialFingerprint)),t=JSON.parse(JSON.stringify(this.fingerprint));delete n.postTypes,delete t.postTypes,e=JSON.stringify(n)!==JSON.stringify(t)}return e},generateFingerprint:function(){var e={adminSearch:_SEARCHWP_VARS.data.misc.admin_search,postTypes:[],taxonomies:[],metadata:[],rules:[]},i=this.engines;for(var n in i)if(i.hasOwnProperty(n)){var r=function(a){if(i[n].hasOwnProperty(a)&&i[n][a].hasOwnProperty("enabled")){var r=i[n][a];r.enabled&&(e.postTypes.push(a),(0,t.default)(r,"tax").forEach(function(i){for(var n in i)i.hasOwnProperty(n)&&i[n]>0&&e.taxonomies.push(a+"_"+n)}),(0,t.default)(r,"cf").forEach(function(i){for(var n in i)i.hasOwnProperty(n)&&e.metadata.push(a+"_"+i[n].metakey)}),(0,t.default)(r,"options").forEach(function(i){for(var n in i)i.hasOwnProperty(n)&&(0!==n.indexOf("limit_to_")&&0!==n.indexOf("exclude_")||e.rules.push(a+"_"+n))}))}};for(var s in i[n])r(s)}return["postTypes","taxonomies","metadata","rules"].forEach(function(i){e[i]=(0,a.default)(e[i]),e[i].sort(function(e,i){return e<i?-1:e>i?1:0})}),e}},created:function(){var n=this;n.initialFingerprint=this.generateFingerprint(),n.fingerprint=this.initialFingerprint,i.EventBus.$on("indexReset",function(){n.dirtyIndex=!1,e.default.set(n.$root.$data.misc,"index_dirty",!1)}),i.EventBus.$on("databaseTablesRecreated",function(){n.resetIndex()})}};exports.default=o;
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,s=e.$createElement,n=e._self._c||s;return n("div",{class:[e.waiting?"searchwp-is-waiting":"","searchwp-engines"]},[n("searchwp-environment-check"),e._v(" "),e.initialSettingsSaved?e.legacySettings?n("searchwp-message",{attrs:{type:"warning",action:{target:e.dismissLegacySettings,text:e.i18n.dismiss}}},[n("p",[e._v(e._s(e.i18n.legacySettingsNotice)+" "),n("br"),n("a",{attrs:{href:"https://searchwp.com/?p=104890",target:"_blank"}},[e._v(e._s(e.i18n.moreInfo)+" »")])])]):e._e():n("searchwp-message",{attrs:{type:"warning",moreInfo:"https://searchwp.com/?p=207"}},[n("p",[e._v(e._s(e.i18n.initialSettingsNotice))])]),e._v(" "),e._l(e.engines,function(s,t){return n("searchwp-engine",{key:t,attrs:{name:t,settings:s,isAdminEngine:e.adminSearchEnabled&&e.adminSearchEngine==t}})}),e._v(" "),e.dirtyIndex?n("searchwp-message",{attrs:{type:"warning",action:{target:e.resetIndex,text:e.i18n.rebuildIndex}}},[n("p",[e._v(e._s(e.i18n.indexDirtyFromEnginesSave))])]):e._e(),e._v(" "),n("ul",{staticClass:"searchwp-engines-actions"},[n("li",{class:{"searchwp-loading":e.saving,"searchwp-saving":e.saving||e.doingSave}},[n("a",{staticClass:"searchwp-button button button-primary",attrs:{href:"#"},on:{click:function(s){return s.preventDefault(),e.saveEngines(s)}}},[e._v(e._s(e.i18n.saveEngines))])]),e._v(" "),e.saving||e.doingSave||e.saved?e._e():n("li",[n("a",{staticClass:"searchwp-button button",attrs:{href:"#"},on:{click:function(s){return s.preventDefault(),e.addEngine(s)}}},[e._v(e._s(e.i18n.addEngine))])]),e._v(" "),e.saved?n("li",{staticClass:"searchwp-success"},[n("span",{staticClass:"searchwp-button button searchwp-button-message"},[n("span",{staticClass:"dashicons dashicons-yes"}),e._v(" "),n("span",[e._v(e._s(e.i18n.saved))])])]):e._e()])],2)},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"vue":"Eruj","./../EventBus.js":"XPQa","md5":"EzLX","keyfinder":"ARas","array-unique":"jryU","./EnvironmentCheck.vue":"fbg6","./Engine.vue":"h4pB","./Message.vue":"xxAh"}],"xpf9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e={name:"SearchwpProgressBar",data:function(){return{alternateIndexer:_SEARCHWP_VARS.data.misc.alternate_indexer}},props:{progress:{type:Number,default:0,required:!0},disabled:{type:Boolean,default:!1,required:!0}}};exports.default=e;
(function(){var s=exports.default||module.exports;"function"==typeof s&&(s=s.options),Object.assign(s,{render:function(){var s=this.$createElement,e=this._self._c||s;return e("div",{class:[this.disabled||this.alternateIndexer?"searchwp-progress-bar--is-disabled":"","searchwp-progress-bar"]},[e("div",{class:[this.progress<100?"searchwp-progress-bar--is-active":"","searchwp-progress-bar__progress"],style:{width:this.progress+"%"}})])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{}],"Fna3":[function(require,module,exports) {
...
},{"vue":"Eruj","./Button.vue":"arid"}],"AzSv":[function(require,module,exports) {
...
},{"vue":"Eruj"}],"Po46":[function(require,module,exports) {
var define;
...
},{}],"opgs":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=o(require("vue")),t=o(require("keyfinder")),i=require("./../EventBus.js"),n=o(require("./ProgressBar.vue")),s=o(require("./Message.vue")),a=o(require("./Confirm.vue")),d=o(require("./Notice.vue")),r=o(require("vue-simple-spinner"));function o(e){return e&&e.__esModule?e:{default:e}}var _={name:"SearchwpIndexStats",components:{"searchwp-progress-bar":n.default,"searchwp-message":s.default,Confirm:a.default,Spinner:r.default,"searchwp-notice":d.default},methods:{resetIndex:function(){var t=this;this.dirtyIndex=!1,this.progress=0,this.indexed=0,this.unindexed="-",this.mainRowCount=0,this.lastActivity=this.i18n.rightNow,this.indexIsResetting=!0,e.default.SearchwpResetIndex().then(function(e){t.indexIsResetting=!1,t.indexIsReset=!0,i.EventBus.$emit("indexReset")}).catch(function(e){alert("ERROR SEARCHWPINDEXRESET")})},updateIndexStats:function(){var t=!1,i=this;i.timeSinceChange>30&&!i.waiting&&(t=!0),e.default.SearchwpGetIndexStats(t).then(function(e){i.progress<100&&i.progress==e.progress?i.timeSinceChange=i.timeSinceChange+5:i.timeSinceChange=0,i.progress=e.progress,i.lastActivity=e.last_activity,i.indexed=e.done,i.unindexed=e.remaining,i.mainRowCount=e.main_row_count,i.waiting=!!e.waiting,setTimeout(function(){i.updateIndexStats()},5e3)}).catch(function(e){})}},created:function(){var e=this;_SEARCHWP_VARS.data.misc.alternate_indexer||e.updateIndexStats(),i.EventBus.$on("enginesSaved",function(i){e.dirtyIndex=i.dirtyIndex,e.initialSettingsSaved=!0;var n=!0;(0,t.default)(i.engines,"enabled").forEach(function(e){e&&(n=!1)}),e.emptyEngines=n}),i.EventBus.$on("indexReset",function(){e.dirtyIndex=!1,e.progress=0,e.indexed=0,e.unindexed="-",e.mainRowCount=0,e.lastActivity=e.i18n.rightNow})},data:function(){return{i18n:{autoScale:_SEARCHWP_VARS.i18n.auto_scale,indexProgress:_SEARCHWP_VARS.i18n.index_progress,lastActivity:_SEARCHWP_VARS.i18n.last_activity,indexDirty:_SEARCHWP_VARS.i18n.index_dirty,indexed:_SEARCHWP_VARS.i18n.indexed,unindexed:_SEARCHWP_VARS.i18n.unindexed,mainRowCount:_SEARCHWP_VARS.i18n.main_row_count,entries:_SEARCHWP_VARS.i18n.entries,rightNow:_SEARCHWP_VARS.i18n.right_now,rows:_SEARCHWP_VARS.i18n.rows,rebuildIndex:_SEARCHWP_VARS.i18n.rebuild_index,indexNote:_SEARCHWP_VARS.i18n.index_note},progress:_SEARCHWP_VARS.data.index_stats.progress,lastActivity:_SEARCHWP_VARS.data.index_stats.last_activity,timeSinceChange:0,indexed:_SEARCHWP_VARS.data.index_stats.done,unindexed:_SEARCHWP_VARS.data.index_stats.remaining,mainRowCount:_SEARCHWP_VARS.data.index_stats.main_row_count,waiting:_SEARCHWP_VARS.data.index_stats.waiting,dirtyIndex:!1,emptyEngines:_SEARCHWP_VARS.data.misc.empty_engines,initialSettingsSaved:_SEARCHWP_VARS.data.misc.initial_settings_saved,indexIsReset:!1,indexIsResetting:!1}}};exports.default=_;
(function(){var s=exports.default||module.exports;"function"==typeof s&&(s=s.options),Object.assign(s,{render:function(){var s=this,t=s.$createElement,e=s._self._c||t;return e("div",{staticClass:"searchwp-index-stats"},[e("div",{staticClass:"searchwp-index-progress"},[e("dl",[e("dt",[s._v(s._s(s.i18n.indexProgress))]),s._v(" "),e("dd",[s._v(s._s(s.progress)+"%")])]),s._v(" "),e("searchwp-progress-bar",{attrs:{progress:s.progress,disabled:!s.initialSettingsSaved||s.emptyEngines}})],1),s._v(" "),s.dirtyIndex||s.$root.misc.index_dirty?e("searchwp-message",{attrs:{type:"warning",action:{target:s.resetIndex,text:s.i18n.rebuildIndex}}},[e("p",[s._v(s._s(s.i18n.indexDirty))])]):s._e(),s._v(" "),s.waiting?e("searchwp-message",[e("p",[s._v(s._s(s.i18n.autoScale))])]):s._e(),s._v(" "),e("table",[e("tbody",[e("tr",[e("th",[s._v(s._s(s.i18n.lastActivity))]),s._v(" "),e("td",[s._v(s._s(s.lastActivity))])]),s._v(" "),e("tr",[e("th",[s._v(s._s(s.i18n.indexed))]),s._v(" "),e("td",[e("span",{staticClass:"code"},[s._v(s._s(s.indexed))]),s._v(" "+s._s(s.i18n.entries))])]),s._v(" "),e("tr",[e("th",[s._v(s._s(s.i18n.unindexed))]),s._v(" "),e("td",[e("span",{staticClass:"code"},[s._v(s._s(s.unindexed))]),s._v(" "+s._s(s.i18n.entries))])]),s._v(" "),e("tr",[e("th",[s._v(s._s(s.i18n.mainRowCount))]),s._v(" "),e("td",[e("span",{staticClass:"code"},[s._v(s._s(s.mainRowCount))]),s._v(" "+s._s(s.i18n.rows))])])])]),s._v(" "),e("p",{staticClass:"description"},[s._v(s._s(s.i18n.indexNote))]),s._v(" "),s._e()],1)},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"vue":"Eruj","keyfinder":"ARas","./../EventBus.js":"XPQa","./ProgressBar.vue":"xpf9","./Message.vue":"xxAh","./Confirm.vue":"Fna3","./Notice.vue":"AzSv","vue-simple-spinner":"Po46"}],"GjBj":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=n(require("./components/Engines.vue")),t=n(require("./components/IndexStats.vue"));function n(e){return e&&e.__esModule?e:{default:e}}var s={name:"SearchwpSettings",components:{"searchwp-engines":e.default,"searchwp-index-stats":t.default}};exports.default=s;
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this.$createElement,s=this._self._c||e;return s("div",{staticClass:"searchwp-settings"},[s("div",{staticClass:"searchwp-engines-index-stats metabox-holder"},[s("searchwp-engines"),this._v(" "),s("searchwp-index-stats")],1)])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"./components/Engines.vue":"nLgC","./components/IndexStats.vue":"opgs"}],"LXja":[function(require,module,exports) {
"use strict";var e=r(require("vue")),t=r(require("v-tooltip")),u=r(require("vue-multiselect")),a=r(require("./inc/Ajax")),s=r(require("./SearchwpSettings.vue"));function r(e){return e&&e.__esModule?e:{default:e}}e.default.use(a.default),e.default.use(t.default),e.default.component("multiselect",u.default),new e.default({el:"#searchwp-settings",data:_SEARCHWP_VARS.data?_SEARCHWP_VARS.data:{},template:"<searchwp-settings></searchwp-settings>",components:{"searchwp-settings":s.default}});
},{"vue":"Eruj","v-tooltip":"RxdG","vue-multiselect":"k6nF","./inc/Ajax":"qaBv","./SearchwpSettings.vue":"GjBj"}]},{},["LXja"], null)