	...
	public function admin_notice() {
		...
		if (
			...
			echo '<div class="updated"><p>';
				...
				printf( esc_html__( 'Allow EWWW Image Optimizer to track plugin usage? Opt-in to tracking and receive 500 free image credits in your admin email: %s. No sensitive data is tracked.', 'ewww-image-optimizer-cloud' ), $admin_email );
