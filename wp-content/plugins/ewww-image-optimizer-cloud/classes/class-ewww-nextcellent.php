	...
	class EWWW_Nextcellent {
		...
		function ewww_ngg_bulk_preview() {
			...
			<div class="wrap">
				...
				$selected_images_text = sprintf( esc_html( _n( 'There is %d image ready to optimize.', 'There are %d images ready to optimize.', count( $attachments ), 'ewww-image-optimizer-cloud' ) ), count( $attachments ) );
				?>
