...
if ( ! class_exists( 'EWWW_Nextgen' ) ) {
	...
	class EWWW_Nextgen {
		...
		function ewww_ngg_bulk_menu() {
			...
			add_submenu_page( NGGFOLDER, esc_html__( 'Bulk Optimize', 'ewww-image-optimizer-cloud' ), esc_html__( 'Bulk Optimize', 'ewww-image-optimizer-cloud' ), apply_filters( 'ewww_image_optimizer_manual_permissions', '' ), 'ewww-ngg-bulk', array( &$this, 'ewww_ngg_bulk_preview' ) );
		}
