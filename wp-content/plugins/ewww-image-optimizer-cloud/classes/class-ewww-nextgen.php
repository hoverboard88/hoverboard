		...
		function ewww_ngg_bulk_preview() {
			...
			<div class="wrap">
				...
				if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ) {
					...
					echo '<a id="ewww-bulk-credits-available" target="_blank" class="page-title-action" style="float:right;" href="https://ewww.io/my-account/">' . esc_html__( 'Image credits available:', 'ewww-image-optimizer-cloud' ) . ' ' . ewww_image_optimizer_cloud_quota() . '</a>';
				}
				...
				$selected_images_text = sprintf( esc_html__( '%1$d images have been selected (%2$d unoptimized), with %3$d resizes (%4$d unoptimized).', 'ewww-image-optimizer-cloud' ), $fullsize_count, $unoptimized_count, $resize_count, $unoptimized_resize_count );
				?>
			...
			if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_debug' ) ) {
				global $ewww_debug;
				echo '<p><strong>' . esc_html__( 'Debugging Information', 'ewww-image-optimizer-cloud' ) . ':</strong></p><div style="background-color:#ffff99;">' . $ewww_debug . '</div>';
			}
			return;
		}
