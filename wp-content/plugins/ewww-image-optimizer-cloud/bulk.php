...
function ewww_image_optimizer_bulk_preview() {
	...
	echo '<div class="wrap"><h1>' . esc_html__( 'Bulk Optimize', 'ewww-image-optimizer-cloud' ) . '</h1>';
	...
	if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ) {
		echo '<span><a id="ewww-bulk-credits-available" target="_blank" class="page-title-action" style="float:right;" href="https://ewww.io/my-account/">' . esc_html__( 'Image credits available:', 'ewww-image-optimizer-cloud' ) . ' ' . ewww_image_optimizer_cloud_quota() . '</a></span>';
	}
	...
	?>
		...
		<form class="ewww-bulk-form" style="border: solid 1px #e5e5e5; background: #fff; padding: 10px;">
			<p><label for="ewww-force" style="font-weight: bold"><?php esc_html_e( 'Force re-optimize', 'ewww-image-optimizer-cloud' ); ?></label><?php echo ewwwio_help_link( 'https://docs.ewww.io/article/65-force-re-optimization', '5bb640a7042863158cc711cd' ); ?>
				...
				&nbsp;<?php esc_html_e( 'Previously optimized images will be skipped by default, check this box before scanning to override.', 'ewww-image-optimizer-cloud' ); ?></p>
		...
		if ( ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_maxmediawidth' ) ||
			...
			if ( ewww_image_optimizer_function_exists( 'print_r' ) ) {
				...
				die(
					ewwwio_json_encode(
						array(
							'error' => esc_html__( 'Error retrieving list of images', 'ewww-image-optimizer-cloud' ),
