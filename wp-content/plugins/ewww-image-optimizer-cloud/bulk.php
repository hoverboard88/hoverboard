		...
		<div id="ewww-bulk-widgets" class="metabox-holder" style="display:none">
			<div class="meta-box-sortables">
				<div id="ewww-bulk-last" class="postbox">
					...
					<h2 class="hndle"><span><?php esc_html_e( 'Last Batch Optimized', 'ewww-image-optimizer-cloud' ); ?></span></h2>
			...
			<div class="meta-box-sortables">
				<div id="ewww-bulk-status" class="postbox">
					...
					<h2 class="hndle"><span><?php esc_html_e( 'Optimization Log', 'ewww-image-optimizer-cloud' ); ?></span></h2>
					<div class="inside"></div>
				</div>
			</div>
		</div>
