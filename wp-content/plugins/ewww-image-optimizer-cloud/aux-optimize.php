...
function ewww_image_optimizer_aux_images() {
	...
	if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_debug' ) ) {
		...
		$output .= '<p><b>' . esc_html__( 'Debugging Information', 'ewww-image-optimizer-cloud' ) . ':</b> <button id="ewww-copy-debug" class="button button-secondary" type="button">' . esc_html__( 'Copy', 'ewww-image-optimizer-cloud' ) . '</button>';
		...
		die(
			ewwwio_json_encode(
				array(
					...
					'message'      => $ready_msg,
					/* translators: %s: number of images */
					'start_button' => sprintf( esc_attr__( 'Optimize %s images', 'ewww-image-optimizer-cloud' ), number_format_i18n( $image_count ) ),
				)
			)
		);
