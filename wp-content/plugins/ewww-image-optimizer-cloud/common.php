...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	$output[] = "<tr class='$network_class'><th scope='row'><label for='ewww_image_optimizer_include_originals'>" .
		esc_html__( 'Include Originals', 'ewww-image-optimizer-cloud' ) . '</label>' .
		...
		esc_html__( 'Optimize the original version of images that have been scaled down by WordPress.', 'ewww-image-optimizer-cloud' ) . "</td></tr>\n";
